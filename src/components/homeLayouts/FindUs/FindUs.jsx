...
const FindUs = () => {
    return (
        <div>
            ...
            <div className="join join-vertical w-11/12 mx-auto md:w-full mt-3 md:mt-7">
                <button className="btn join-item bg-base-100 border-secondary shadow-none justify-start h-14">
