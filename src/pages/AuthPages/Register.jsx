            ...
            <div className='card bg-base-100 w-11/12 md:w-full shrink-0 p-8 md:p-16 shadow-2xl'>
                ...
                <div className='card-body'>
                    <form className='fieldset'>
                        ...
                        <input type="text" name="name" className="input w-full mb-3 text-secondary bg-base-300" placeholder="Enter your name" />
                        <label className="label font-bold text-lg md:text-xl text-primary">Photo URL</label>
                        <input type="url" name="photo" className="input w-full mb-3 text-secondary bg-base-300" placeholder="Enter your Photo URL" />
